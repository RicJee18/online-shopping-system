        ...
        <div class="row d-flex" style="margin-top:-50px">
            ...
            <div class="col-lg-6">
                <div class="card2 card border-0 px-4 py-5">
                    <form action="" method="post" id="contact-form">
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <input class="mb-4" type="text" name="firstname" placeholder="Enter your firstname">
                            </div>
                            <div class="col-6">
                                <label class="mb-1"><h6 class="mb-0 text-sm">Lastname</h6></label>
                                <input class="mb-4" type="text" name="lastname" placeholder="Enter your lastname">
                            </div>           
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <label class="mb-1"><h6 class="mb-0 text-sm">Mobile Number</h6></label>
                                <input class="mb-4" type="text" name="mobile" placeholder="Enter your firstname">
                            </div>
                            <div class="col-6">
                                <label class="mb-1"><h6 class="mb-0 text-sm">Address</h6></label>
                                <input class="mb-4" type="text" name="address" placeholder="Enter your lastname">
                            </div>           
                        </div>
                        <div class="row px-3">
                             <label class="mb-1">
                    ...
                    <div class="row mb-4 px-3"> <small class="font-weight-bold">Already have an account? <a class="text-danger" href="landing.php">Sign in</a></small> </div>
                </div>
            </div>
        </div>
    </div>
